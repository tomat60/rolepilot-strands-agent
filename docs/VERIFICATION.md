...
PR #2 was merged to `main` on 2026-09-06 as merge commit `770879c853fa0b8c90295ef837b454c3d7eb6b7a` after the verified implementation head passed its release gate.

Still outstanding before final submission:
